...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Crear Establecimiento</h3>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="/home">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{ route('establishments.index') }}">Establecimientos</a></div>
                <div class="breadcrumb-item active">Crear Establecimiento</div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => 'establishments.store', 'method' => 'POST']) }}
